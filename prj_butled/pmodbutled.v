/*
IMPORTANT:
Must place the Papilio wingbutled only on the PMOD PIO pins, ie: avoid all 3.3V/GND pins!
Pmod    Wing    Out     In
PIO_08  GND     0
PIO_07  2V5     z
PIO_06  3V3     1
PIO_05  5V      z
PIO_04  LED4    leds[3]
PIO_03  PB4     z       buttons[3]
PIO_02  LED3    leds[2]
PIO_01  PB3     z       buttons[2]
*/
module pmodbutled (
    inout [8:1] pio,
    output [3:0] buttons,
    ...
    assign buttons[3] = pio[3];
    assign buttons[2] = pio[1];
endmodule
